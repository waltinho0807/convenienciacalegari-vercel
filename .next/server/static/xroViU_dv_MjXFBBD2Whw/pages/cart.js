...
const CartItemList = ({
  ...
  if (products.length === 0) {
    ...
    }), "N\xE3o h\xE1 produtos no carrinho. Adicione!"), __jsx("div", null, user ? __jsx(external_semantic_ui_react_["Button"], {
      color: "violet",
      onClick: () => router.push('/products')
    }, "Visualizar Produtos") : __jsx(external_semantic_ui_react_["Button"], {
      color: "blue"
